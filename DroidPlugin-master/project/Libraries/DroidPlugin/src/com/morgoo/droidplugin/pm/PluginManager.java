...
/**
 * Êèí‰ª∂ÂåÖÁÆ°ÁêÜÊúçÂä°ÁöÑÂÆ¢Êà∑Á´ØÂÆûÁé∞„ÄÇ
 * <p/>
...
public class PluginManager implements ServiceConnection {
	...
	//¡¨Ω”…œ∑˛ŒÒ“‘∫Û,ª·µ˜”√PluginManagerµƒonServiceConnected()£¨ ’‚“ª≤Ω±»Ωœπÿº¸£∫
    @Override
    public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
    	/*¥¥Ω®≤¢±£¥ÊIPluginManagerImpl Proxy∂‘œÛ£¨
    	*¥¥Ω®œﬂ≥Ã,µ»¥˝IPluginManagerImpl≥ı ºªØÕÍ≥…∫Û,
    	*µ»¥˝IPluginManagerImpl≥ı ºªØÕÍ≥…∫Û,∑÷∑¢∑˛ŒÒ¡¨Ω”≥…π¶º‡Ã˝,◊¢≤·∑˛ŒÒÀ¿Õˆªÿµ˜
    	*/
        mPluginManager = IPluginManager.Stub.asInterface(iBinder);//PluginManagerServiceµƒ¥˙¿Ì∂‘œÛImpleOPluginManager
        new Thread() {
            @Override
            public void run() {
                try {
					...
					//≤Èø¥IPluginManagerImpl÷–µƒregisterApplicationCallback
    ...
    public void onServiceDisconnected(ComponentName componentName) {
        ...
        //ÊúçÂä°ËøûÊé•Êñ≠ÂºÄÔºåÈúÄË¶ÅÈáçÊñ∞ËøûÊé•„ÄÇ
        connectToService();
    }
    ...
    /**
     * Êèê‰æõË∂ÖÊó∂ËÆæÁΩÆÁöÑwaitForConnectedÁâàÊú¨
     *
     * @param timeoutÔºåÂΩìË∂ÖÊó∂Êó∂Èó¥Â§ß‰∫é0Êó∂Ë∂ÖÊó∂ËÆæÁΩÆÁîüÊïà
     */
