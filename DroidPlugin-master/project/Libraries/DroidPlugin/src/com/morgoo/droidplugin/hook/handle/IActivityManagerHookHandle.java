    ...
    private static class startActivity extends ReplaceCallingPackageHookedMethodHandler {
        ...
        protected boolean doReplaceIntentForStartActivityAPIHigh(Object[] args) throws RemoteException {
            ...
            if (args != null && args.length > 1 && intentOfArgIndex >= 0) {
                ...
                ActivityInfo activityInfo = resolveActivity(intent);//��ȡactivityinfo����ȷ����һ���������
				/*
				*�����ȡ����intent�ǲ������������װ����
				*/
                if (activityInfo != null && isPackagePlugin(activityInfo.packageName)) {
                    ComponentName component = selectProxyActivity(intent);//���ݴ����������intent��ȡ���Ӧ��stubActivity
                    if (component != null) {
                        ...
                        newIntent.putExtra(Env.EXTRA_TARGET_INTENT, intent);// ԭʼintent��ӦEXTRA_TARGET_INTEN
                        newIntent.setFlags(intent.getFlags());//����ԭ������flag
            ...
            if (args != null && args.length > 1 && intentOfArgIndex >= 0) {
                ...
                if (activityInfo != null && isPackagePlugin(activityInfo.packageName)) {
                    ...
                    if (component != null) {
                        Intent newIntent = new Intent();
                        newIntent.setComponent(component);
                        newIntent.putExtra(Env.EXTRA_TARGET_INTENT, intent);// ԭʼintent��ӦEXTRA_TARGET_INTENT
                        newIntent.setFlags(intent.getFlags());//����ԭ������flag
                        if (TextUtils.equals(mHostContext.getPackageName(), activityInfo.packageName)) {
                            newIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);//������������������Ĳ��������FLAG_ACTIVITY_NEW_TASK��һ���µ�task���������
                        }
                        args[intentOfArgIndex] = newIntent;
                    } else {
                        Log.w(TAG, "startActivity,replace selectProxyActivity fail");
