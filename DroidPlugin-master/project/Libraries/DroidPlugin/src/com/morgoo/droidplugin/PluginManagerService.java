...
public class PluginManagerService extends Service {
    ...
    public void onCreate() {
		...
		//¹¹Ôìº¯ÊıÖĞÖ»ÓĞÒ»¸öMyActivityManagerService¶ÔÏó£¬ÓÃÀ´¶Ô²å¼ş½ø³Ì½øĞĞ¹ÜÀíµÄ
        mPluginPackageManager.onCreate();

    }
	//ÌáÉıserviceËùÔÚ½ø³ÌµÄÓÅÏÈ¼¶
    private void keepAlive() {
        try {
            Notification notification = new Notification();
            notification.flags |= Notification.FLAG_NO_CLEAR;
            notification.flags |= Notification.FLAG_ONGOING_EVENT;
            startForeground(0, notification); // è®¾ç½®ä¸ºå‰å°æœåŠ¡é¿å…killï¼ŒAndroid4.3åŠä»¥ä¸Šéœ€è¦è®¾ç½®idä¸º0æ—¶é€šçŸ¥æ æ‰ä¸æ˜¾ç¤ºè¯¥é€šçŸ¥ï¼›
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
