...
//        builder.show();
    	if (!PluginManager.getInstance().isConnected()) {
			...
			try {
				PluginManager.getInstance().deletePackage(
						item.packageInfo.packageName, 0);
    ...
    private InstallApkReceiver mInstallApkBroadcastReceiver = new InstallApkReceiver();

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mInstallApkBroadcastReceiver.registerReceiver(getActivity().getApplication());
    ...
    public void onDestroy() {
        ...
        mInstallApkBroadcastReceiver.unregisterReceiver(getActivity().getApplication());
        super.onDestroy();
    }
